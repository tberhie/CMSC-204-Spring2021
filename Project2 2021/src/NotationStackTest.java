...
public class NotationStackTest {
	...
	public double q=1.0, r=2.0, t=3.0, y=4.0, u=5.0 ,z=6.0;
	...
	public void testPopStudent() {
		...
		try {
			assertEquals(t, (Object)doubleS.pop());
			assertEquals(r, (Object)doubleS.pop());
			assertEquals(q, (Object)doubleS.pop());
			doubleS.pop();
			assertTrue("This should have caused an StackUnderflowException", false);
		}
		catch (StackUnderflowException e){
	...
	public void testPushStudent() {
		...
		try {
			...
			assertEquals(true, doubleS.push(u));
	...
	public void testToStringStudent() throws StackOverflowException {
		...
		doubleS.push(y);
		assertEquals("1.02.03.04.04.0", doubleS.toString());
	}
